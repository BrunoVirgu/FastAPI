...
[![codecov](https://codecov.io/gh/BrunoVirgu/FastAPI/branch/main/graph/badge.svg?token=FastAPI_token_here)](https://codecov.io/gh/BrunoVirgu/FastAPI)
[![CI](https://github.com/BrunoVirgu/FastAPI/actions/workflows/main.yml/badge.svg)](https://github.com/BrunoVirgu/FastAPI/actions/workflows/main.yml)

Awesome fastapi created by BrunoVirgu

## Install

from source
```bash
git clone https://github.com/BrunoVirgu/FastAPI fastapi
cd fastapi
make install
```
